...
class Products {
    ...
    companion object {
        ...
        val BLUE_MUG = Product(
            "Blue Coffee Mug",
            "Blue Coffee Mug for drinking coffee. 100% ceramic.",
            R.drawable.blue_mug,
            BigDecimal(5.99),
            BigDecimal(0),
            66,
        ...
        val WHITE_MUG = Product(
            "White Coffee Mug",
            "White Coffee Mug for drinking coffee. 100% ceramic.",
            R.drawable.white_mug,
            BigDecimal(6.99),
            BigDecimal(0),
            7,
            BigDecimal(4),
        ...
        val RED_MUG = Product(
            "Red Coffee Mug Red",
            "Red Coffee Mug for drinking coffee. 100% ceramic.",
            R.drawable.red_mug,
            BigDecimal(8.99),
            BigDecimal(0),
            157,
        ...
        val BLACK_HAT = Product(
            "Black Baseball Hat",
            "Black Baseball Hat made of 100% authentic " +
        ...
        val BLUE_HAT = Product(
            "Blue Baseball Hat",
            "Blue Baseball Hat made of 100% authentic " +
                    "baseball hat material.",
            R.drawable.blue_hat,
            BigDecimal(22.99),
            BigDecimal(0),
        ...
        val WHITE_HAT = Product(
            "White Baseball Hat",
            "White Baseball Hat made of 100% authentic " +
                    "baseball hat material.",
        ...
        val ORANGE_HAT = Product(
            "Orange Baseball Hat",
            "Orange Baseball Hat made of 100% authentic " +
                    "baseball hat material.",
        ...
        val GREEN_HILLS_PICTURE = Product(
            "Picture of green hills in GreenLand",
            "A calming image of a sunset in " +
                    "Greenland.",
        ...
        val HAVASU_FALLS_PICTURE = Product(
            "A Very Famous Picture of Havasu Falls",
            "Check out this famous picture " +
                    "of Havasu Falls.",
            R.drawable.havasu_falls,
            BigDecimal(76),
            BigDecimal(0),
            81,
            BigDecimal(4.9),
    ...
    init {
        for (product in PRODUCTS) {
            PRODUCT_MAP[(product.serial_number).toString()] = product
        }
    }
}
